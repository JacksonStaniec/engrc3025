import { Center, Group, Pill, Text, Title } from '@mantine/core';
...
export const DTI = () => (
  <>
    ...
    <Text>
      ...
      developers that implement several new product features.
    </Text>
    <Title mt="xs" order={4}>
      Background
    </Title>
    <Text>
      Cornell DTI is a project team that create web applications for commnity use -- like QueueMeIn
      that professors use to manage office hours. The IDOL (Internal DTI Organization Logic) subteam
      is responsible for creating and maintaining tools for the team leads to more easily manage the
      ~100 members of the project team. assignemtns for debs is the portfolio. All hands meetings.
      Team events.
    </Text>
    <Text mt="sm">
    ...
    <ul>
      <li>
        ...
        Each developer on the team must periodically submit a link to the GitHub PRs that they have
        made, so we can check that they are making steady contributions.
      </li>
      <li>
    ...
    <Text>
      One product we released was an autograder that uses GitHub APIs to verify developer portfolios
      based on all 3 criteria holding.
    </Text>
    <ol>
      ...
      <li>
        At least 2 PR links must be an original, meaningful contribution, measured in terms of lines
        of code.
      </li>
    </ol>
    <Text>
      Members would submit these portfolios through a form on the IDOL website, and admins would be
      able to review the grades, override the determination based on exceptions, and manage
      portfolio assignments.
    </Text>
    <Text mt="xs">
      Another product that was revitalized was Shoutouts, which allow for members to send anonymous
      messages praising certain other members that would be read during the all-hands meetings.
    </Text>
    <Title mt="xs" order={4}>
      Results
    </Title>
  ...
  return (
    <>
      ...
      <Text>
        ...
        generation, intermediate representation (IR) generation, and assembly instruction selection.
      </Text>
      <Title mt="xs" order={4}>
        Background
      </Title>
